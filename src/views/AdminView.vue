    ...
    <v-card class="pa-6">
      <div>
        ...
        <div flex>
          ...
          >
          <v-btn
            @click="showFlightRoute = !showFlightRoute"
            outlined
            color="indigo"
            flex
            >FlightRoute</v-btn
          ...
          >
          <v-btn
            @click="showAvailableSeats = !showAvailableSeats"
            outlined
            color="indigo"
            flex
            >AvailableSeats</v-btn
          >
          <v-btn @click="showTicket = !showTicket" outlined color="indigo" flex
            >Ticket</v-btn
          ><v-btn
            @click="showCheckin = !showCheckin"
            outlined
            color="indigo"
            flex
            >Checkin</v-btn
      ...
      <div>
        ...
        </div><div v-show="showAirline">
          <v-spacer class="pa-6"></v-spacer>
          <AirlineTable></AirlineTable>
        </div><div v-show="showAirport">
          <v-spacer class="pa-6"></v-spacer>
